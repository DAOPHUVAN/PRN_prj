#pragma checksum "C:\Users\Hello\Downloads\PRN231 (1)\PRN231\Downloads\BookManagement-master\BookManagement-master\WebClient\Views\Publishers\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e15707b98bb887ed298cd7d2a47ec4ea0182be05"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e15707b98bb887ed298cd7d2a47ec4ea0182be05", @"/Views/Publishers/Index.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\Hello\Downloads\PRN231 (1)\PRN231\Downloads\BookManagement-master\BookManagement-master\WebClient\Views\Publishers\Index.cshtml"
...
<div class=""card"">
	...
	<div class=""card-body"">
		<div class=""row"">
			...
			<div class=""col-md-12"">
				");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e15707b98bb887ed298cd7d2a47ec4ea0182be055472", async() => {
                WriteLiteral(@"
			...
			<div class=""col-md-12"">
				...
				");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e15707b98bb887ed298cd7d2a47ec4ea0182be058925", async() => {
                WriteLiteral(@"
					<hr />
	...
	dataset.forEach((item, idx) => {
		...
		<tr id=""${item.id}"">
			...
			<td>
				...
				<button name=""btn-delete"" class=""btn btn-danger m-1"" value=");
                WriteLiteral(@"""${idx}"">Remove</button>
			</td>
		<tr>
		`;
    });
...
var deleteBtnClicked = (e) => {
    ...
    if (confirm(`Delete publisher with Id=${delet");
                WriteLiteral(@"eSelectedItem.id}? You cannot reverse data!`)) {
...
frm.submit(function (e) {
	...
	(new FormData(e.target)).forEach(function(value, key){
		// check can parse from");
                WriteLiteral(@" string to int or not
		if(!isNaN(value)){
		...
		success: function (item) {
			...
			let newRow =
				`<tr id=""${item.id}"">
					...
					<td>${item.country.name}</td>
					<td>
						<button name=""btn-update"" class=""btn btn-success m-1"" value=""${selectedIndex}"">Edit</button>
